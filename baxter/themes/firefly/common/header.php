...
<!-- typekit -->
 ...
 <?php echo body_tag(array('id' => @$bodyid, 'class' => @$bodyclass)); ?>
    ...
    <header>
        ...
        <h1 id="logo"><a class="no-decoration" href="/" accesskey="1"><img src="http://emlo.bodleian.ox.ac.uk/img/emlo_logo.png" alt="EMLO logo" class="show-for-large-up menu-name"/></a>
