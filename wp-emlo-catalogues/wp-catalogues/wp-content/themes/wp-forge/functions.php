...
if ( ! function_exists( 'wpforge_scripts_styles' ) ) {
	function wpforge_scripts_styles() {
		...
		wp_register_script ( 'modernizr', get_template_directory_uri() . '/js/vendor/modernizr.js', array('jquery'), '5.5.0.1', false );
		wp_register_script ( 'foundation-js', get_template_directory_uri() . '/js/foundation.min.js', array('jquery'), '5.5.0.1', true );
		wp_register_script ( 'functions-js', get_template_directory_uri() . '/js/functions.js', array('jquery'), '5.5.0.1', true );
